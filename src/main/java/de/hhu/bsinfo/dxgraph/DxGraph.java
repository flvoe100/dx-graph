...
public class DxGraph {
    ...
    public DxGraph(ServiceProvider p_context, Format p_datasetFormat) {
    ...
    public void loadGraph() {
        ...
        GraphLoadingTask graphLoadingTask = new GraphLoadingTask(m_datasetFormat.getVertexFilePath().toString(), m_datasetFormat.getEdgeFilePath().toString(), m_masterNodeID, m_graph);
        ...
        System.out.println(String.format("Graph loading time: %d nanosecs", end - start));
    }
